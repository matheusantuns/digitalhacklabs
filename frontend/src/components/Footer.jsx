        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="sm:col-span-2">
            <div className="flex items-center space-x-3 sm:space-x-4 mb-4 sm:mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-slate-400 hidden sm:block mt-1">
                  ESPECIALISTAS EM GOOGLE, META E TIKTOK
                </p>
              </div>
            </div>
            ...
            {/* 3 QUADRADINHOS ESPECIALIDADES */}
            <div className="grid grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8 max-w-md">
              <div className="premium-card p-3 sm:p-4 text-center">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg gradient-bg flex items-center justify-center mx-auto mb-2">
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                  </svg>
                </div>
                <span className="text-xs sm:text-sm font-semibold text-white">Google Ads</span>
              </div>
              ...
              <div className="premium-card p-3 sm:p-4 text-center">
                ...
                <span className="text-xs sm:text-sm font-semibold text-white">Meta Ads</span>
              </div>
              ...
              <div className="premium-card p-3 sm:p-4 text-center">
                ...
                <span className="text-xs sm:text-sm font-semibold text-white">TikTok Ads</span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#resultados" className="text-slate-400 hover:text-blue-400 transition-colors text-sm">Case de Sucesso</a></li>
